...
if __name__=="__main__":
    ...
    birds = (
        ("Swallow are a group of birds in the family Hirundinidae.", swallow),
        ("African swallows are said to be able to carry cocumuts.", african),
        ("European swallows are said to have trouble carrying cocunuts.", european),
        )
